...
class PurchaseModel {
  ...
  factory PurchaseModel.fromJson(Map<String, dynamic> json) {
    ...
    return PurchaseModel(
      purchaseId: json['purchase_id'] as String? ?? json['id'] as String? ?? '',
      ...
      totalPrice: (json['total_price'] as num?)?.round() ?? 0,
      status: PurchaseStatus.fromString(json['status'] as String? ?? 'draft'),
      createdAt:
