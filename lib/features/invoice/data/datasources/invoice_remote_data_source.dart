  ...
  Future<InvoiceModel> uploadPaymentProof(
    ...
    await apiClient.post<Map<String, dynamic>>(
      ...
      data: {
        ...
        'payment_proof_url': 'http://situkang-api-v2.eastasia.azurecontainer.io:7860/v1/proofs/proof_$orderId.jpg',
        'transaction_proof_url': 'http://situkang-api-v2.eastasia.azurecontainer.io:7860/v1/proofs/proof_$orderId.jpg',
      },
    );
    // Refetch the updated invoice
    return getInvoice(orderId);
